...
cv::Mat frontEndInfo::extrinsticMat(3, 4, CV_64F, EXPAR);

cv::Mat frontEndInfo::intrinsticMat(3, 3, CV_64F, INPAR);
cv::Mat frontEndInfo::distortionMatrix(5, 1, CV_64F, DIST);
